...
--
-- Name: persons Users can insert their own profile.; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can insert their own profile." ON public.persons FOR INSERT WITH CHECK ((auth.uid() = id));


--
-- Name: persons Users can update own profile.; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can update own profile." ON public.persons FOR UPDATE USING ((auth.uid() = id));


--
-- Name: persons Users can view their own profile.; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can view their own profile." ON public.persons FOR SELECT USING ((auth.uid() = id));
